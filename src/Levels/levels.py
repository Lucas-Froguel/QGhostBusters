...
class TestLevel(BaseLevel):
    ...
    def load_level(self):
        ...
        self.ghosts_group = [
            QGhost(cellSize=self.cellSize, worldSize=self.worldSize, position=Vector2(20, 10)),
            QGhost(cellSize=self.cellSize, worldSize=self.worldSize, position=Vector2(10, 16)),
        ]
